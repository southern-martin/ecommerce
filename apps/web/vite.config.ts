...
export default defineConfig({
  ...
  server: {
    ...
    proxy: {
      ...
      // ── Supporting services ──
      '/api/v1/shipping': { target: 'http://localhost:28085', changeOrigin: true },
      '/api/v1/returns': { target: 'http://localhost:28086', changeOrigin: true },
      '/api/v1/search': { target: 'http://localhost:28087', changeOrigin: true },
      '/api/v1/reviews': { target: 'http://localhost:28088', changeOrigin: true },
      '/api/v1/media': { target: 'http://localhost:28089', changeOrigin: true },
      '/api/v1/notifications': { target: 'http://localhost:28092', changeOrigin: true },
      '/api/v1/promotions': { target: 'http://localhost:28093', changeOrigin: true },
      '/api/v1/chat': { target: 'http://localhost:28094', changeOrigin: true },
      ...
      '/api/v1/seller/shipments': { target: 'http://localhost:28085', changeOrigin: true },
      '/api/v1/seller/carriers': { target: 'http://localhost:28085', changeOrigin: true },
      '/api/v1/seller/returns': { target: 'http://localhost:28086', changeOrigin: true },
      ...
      '/api/v1/admin/carriers': { target: 'http://localhost:28085', changeOrigin: true },
      ...
      '/api/v1/admin/reviews': { target: 'http://localhost:28088', changeOrigin: true },
      '/api/v1/admin/disputes': { target: 'http://localhost:28086', changeOrigin: true },
      ...
      // ── WebSocket ──
      '/ws': { target: 'ws://localhost:28094', ws: true },
    },
  },
});
